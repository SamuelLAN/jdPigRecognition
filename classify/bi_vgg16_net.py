...
class VGG16(base.NN):
    ...
    # 学习率的相关参数
    BASE_LEARNING_RATE = [0.00005, 0.00005, 0.00008, 0.00005, 0.00005, 0.00005, 0.00005, 0.00005, 0.00005, 0.00005,
    ...
    DECAY_RATE = [0.0001, 0.0001, 0.00003, 0.00006, 0.00006, 0.00006, 0.0001, 0.0001, 0.0001, 0.0001,
    ...
    # 防止 overfitting 相关参数
    REGULAR_BETA = [0.1, 0.1, 2.5, 0.1, 0.1, 0.1, 3.8, 0.6, 0.35, 0.2,
