...
class VGG16(base.NN):
    ...
    EPOCH_TIMES = 150  # 随机梯度下降的 batch 大小
    ...
    # 学习率的相关参数
    BASE_LEARNING_RATE_1 = [0.00000005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005,
                            0.000005,
    ...
    DECAY_RATE_1 = [0.001, 0.0001, 0.0001, 0.00006, 0.00006, 0.00006, 0.0001, 0.0001, 0.0001, 0.0001,
                    0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.00006, 0.0001,
                    0.0001, 0.0001, 0.00007, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.00008, 0.00008]

    # 防止 overfitting 相关参数
    REGULAR_BETA_1 = [0.01, 0.1, 0.3, 0.1, 0.1, 0.1, 0.03, 0.2, 0.15, 0.2,
                      0.1, 0.1, 0.01, 0.1, 0.1, 0.15, 0.1, 0.03, 0.03, 0.01,
                      0.1, 0.1, 0.01, 0.03, 0.02, 0.3, 0.5, 0.2, 0.01, 0.04]  # 正则化的 beta 参数
    ...
    def run(self):
        ...
        for i in range(self.NUM_PIG):
            ...
            break  # @TODO test param, need to be deleted
...
o_vgg = VGG16(False, '2018_01_10_16_05_43')
# o_vgg = VGG16(False)
o_vgg.run()
