...
class VGG16(base.NN):
    ...
    # 学习率的相关参数
    BASE_LEARNING_RATE_1 = [0.0005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005, 0.000005,
    ...
    LOSS_TYPE = 2  # loss type 有两种；0：使用正常的loss，1：使用log_loss
